...
<div class="page-sidebar" style="position:fixed; z-index:100; ">
  ...
  <div class="sidebar custom-scrollbar">
    ...
    <ul class="sidebar-menu" style="z-index:100;">
    ...
    <li class="mb-3">
      ...
      <?php
        ...
        ?>
          ...
          <li>
            <a href="../admission/quick-enrollment-online.php"
              ><i class="fa fa-circle"></i><span>Online Enrollment</span></a
            >
          </li>
           <li>
            <a href="../admission/quick-register-student-online.php"
              ><i class="fa fa-circle"></i><span>Student Register</span></a
            >
          </li>
        <?php            
          }
        ...
        ?>
          ...
          <li>
            <a href="../admission/latest-student-list.php"
              ><i class="fa fa-circle"></i><span>Latest Student List </span></a
            >
          </li>
          <li>
            <a href="../admission/walk-in-list.php"
              ><i class="fa fa-circle"></i><span>Walkin List </span></a
            >
          </li>
           <li>
            <a href="../admission/Payment.php"
              ><i class="fa fa-circle"></i><span>View Payment </span></a
            >
          </li>
        <?php            
          }
      ...
      <?php
        ...
        ?>
          <li>
            <a href="../assignments/assignment-list.php"
...
<li  onmouseover="changePosition(6);" onmouseout="changePosition2(6); " id="ul-menu6" > 
      <?php
        ...
        ?>
        <a class="sidebar-header" href="#"
          ><i data-feather="list"></i><span>Batch</span
          ><i class="fa fa-angle-right pull-right"></i
        ></a>
        <?php
          }
...
<ul class="sidebar-submenu sidebar custom-scrollbar"  id="menu6" style="left:10px !important; z-index:10000000; max-height:300px; height:auto;overflow-y:auto;!important; transition: all 0.2s" >         
      ...
      <li  onmouseover="changePosition(19);" onmouseout="changePosition2(19); " id="ul-menu19" > 
      <?php
          if ($_SESSION['ftip69_role'] == 'superadmin') {
        ?>
        <a class="sidebar-header" href="#"
          ><i data-feather="list"></i><span>Blog</span
          ><i class="fa fa-angle-right pull-right"></i
        ></a>
        <?php
          }
...
<ul class="sidebar-submenu sidebar custom-scrollbar"  id="menu19" style="left:10px !important; z-index:10000000; max-height:300px; height:auto;overflow-y:auto;!important; transition: all 0.2s" >         
        ...
        ?>
          <li>
            <a href="../blog/blog-add.php"
              ><i class="fa fa-circle"></i><span>Add blog</span></a
            >
          </li>
        <?php            
          }
        ...
        ?>
          <li>
            <a href="../blog/blog-list.php"
              ><i class="fa fa-circle"></i><span>Blog List</span></a
            >
          </li>
        <?php            
          }
    ...
    <?php
      ...
      <li  onmouseover="changePosition(1);" onmouseout="changePosition2(1); " id="ul-menu1"  class="text-center">
        <a class="sidebar-header text-white"  href="#" id="leads" onclick=""
          ><i data-feather="database"></i><span>CRM</span
          ><i class="fa fa-angle-right pull-right"></i
        ></a>
        <ul class="sidebar-submenu sidebar custom-scrollbar"  id="menu1" style="left:10px !important; z-index:10000000 !important; max-height:300px; height:auto; overflow-y:auto;!important; transition: all 0.2s;" >
        <?php
          if ($_SESSION['ftip69_role'] == 'superadmin') {
        ?>
          <!-- <li>
        ...
        ?>
          ...
          <li>
            <a href="../leads/walk-in-list-new.php"
              ><i class="fa fa-circle"></i><span>Walk In List New</span></a
            >
          </li>
          <li>
      ...
      <?php
        ...
        ?>
          ...
          <li>
            <a href="../settings/sharing-management.php"
              ><i class="fa fa-circle"></i><span>Sharing Management</span></a
            >
          </li> 
          <li>
          ...
          <li>
            <a href="../notification-management/notification-management.php"
              ><i class="fa fa-circle"></i><span>Manage Notification</span></a
            >
          </li>
          ...
          <li>
            <a href="../settings/blog-category.php"
              ><i class="fa fa-circle"></i><span>Blog Category</span></a
            >
          </li>  
        ...
        ?>
          <li>
            <a href="../test/mcq-test-list.php"
              ><i class="fa fa-circle"></i><span>Test List</span></a
            >
          </li>
          <li>
            <a href="../test/question-test-list.php"
              ><i class="fa fa-circle"></i><span>Question List</span></a
            >
          </li>
      ...
      <?php
          if ($_SESSION['ftip69_role'] == 'superadmin') {
        ?>
      <li  onmouseover="changePosition(18);" onmouseout="changePosition2(18); " id="ul-menu18" > 
        <a class="sidebar-header" href="#"
          ><i data-feather="code"></i><span>Projects</span
          ><i class="fa fa-angle-right pull-right"></i
        ></a>
        <ul class="sidebar-submenu sidebar custom-scrollbar"  id="menu18" style="left:10px !important; z-index:10000000; max-height:300px; height:auto;overflow-y:auto;!important; transition: all 0.2s" >
          <li>
              <a href="../projects/add-project.php"
                ><i class="fa fa-circle"></i><span>Add Project</span></a
              >
          </li>
          <li>
              <a href="../projects/project-list.php"
                ><i class="fa fa-circle"></i><span>Project List</span></a
              >
          </li>
          <li>
              <a href="../projects/assign-projects.php"
                ><i class="fa fa-circle"></i><span>Assign Project</span></a
              >
          </li>
      ...
      <?php
          if ($_SESSION['ftip69_role'] == 'superadmin') {
        ?>
      <li  onmouseover="changePosition(20);" onmouseout="changePosition2(20); " id="ul-menu20" > 
        <a class="sidebar-header" href="#"
          ><i data-feather="globe"></i><span>Website Data</span
          ><i class="fa fa-angle-right pull-right"></i
        ></a>
        <ul class="sidebar-submenu sidebar custom-scrollbar"  id="menu20" style="left:10px !important; z-index:10000000; max-height:300px; height:auto;overflow-y:auto;!important; transition: all 0.2s" >
        <li>
              <a href="../website/get-started.php"
                ><i class="fa fa-circle"></i><span>Get Started</span></a
              >
          </li>
          <li>
              <a href="../website/book-demo.php"
                ><i class="fa fa-circle"></i><span>Book Demo</span></a
              >
          </li>
          <li>
              <a href="../website/callback-requests.php"
                ><i class="fa fa-circle"></i><span>Callback Requests</span></a
              >
          </li>
          <li>
              <a href="../website/walk-in-form.php"
                ><i class="fa fa-circle"></i><span>Walk In Form</span></a
              >
          </li>
...
function changePosition(n){
  ...
  document.getElementById('menu'+n).style.top = elementOffset-offsetY+80+"px";
