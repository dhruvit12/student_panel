   ...
   <div class="col-lg-3">
      <div class="jumbotron mt-5" id="sidebar">
         <img class="" alt="100x100" src="<?php echo base_url()?>assets/images/logo/logo.png"
            style="margin-left: 0px;width:150px;border-radius: 16px;">
       ...
       <div class="row">
           ...
           <div>
           <a href="dashboard" >
              <svg id="Layer_1" style="height: auto;width: 28px;" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 425.11 413.39" fill="#808080">
            ...
            <a href="course">
             <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
               viewBox="0 0 773.4 774.33" style="height: auto;width: 25px;fill:#808080"; xml:space="preserve">
                   ...
                   <div class="col-lg-2" id="header-text">
                    ...
                    <div class="col-lg-2" id="header-text" >
                     ...
                     <?php if($this->uri->segment(1)=='quiz'){
                        ?>
                        <div id="line" style="margin-left: 0px">
                        </div>
                      <?php
                      } ?>
                   </div>
