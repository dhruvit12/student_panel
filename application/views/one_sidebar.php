   ...
   <div class="col-lg-3">
      <div class="jumbotron mt-5" id="sidebar">
       ...
       <div class="row">
           ...
           <div>
           <a id="menu_dashboard" href="<?php echo base_url()?>dashboard" onmouseover="changeSidebarIconColor(1)" onmouseout="changeSidebarIconColorOut(1)">
            ...
            <a id="menu_course" href="<?php echo base_url()?>course" onmouseover="changeSidebarIconColor(2)" onmouseout="changeSidebarIconColorOut(2)">
            ...
            <a id="menu_editprofile" href="<?php echo base_url()?>edit_profile" onmouseover="changeSidebarIconColor(5)" onmouseout="changeSidebarIconColorOut(5)"> 
             ...
             <a id="menu_support" href="<?php echo base_url()?>support"  onmouseover="changeSidebarIconColorfa(6)" onmouseout="changeSidebarIconColorOutfa(6)"><i class="fa fa-support"  class="icon" id="sidebar_icon_6" style="font-size: 20px;margin-bottom:5px;"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Support</a>
             <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url()?>logout" onmouseover="changeSidebarIconColor(7)" onmouseout="changeSidebarIconColorOut(7)">
