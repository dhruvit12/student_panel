   ...
   <div class="col-lg-3">
      <div class="jumbotron mt-5" id="sidebar">
       ...
       <div class="row">
           ...
           <div>
           <a href="dashboard" >
              <svg id="Layer_1" class="icon" style="height: auto;width: 23px;margin-bottom:5px;font-family:Poppins" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 425.11 413.39" fill="#808080">
